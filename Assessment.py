...
def main():
    ...
    stringA = '\n'+str(np.shape(users)[0]) + ' ' + str(np.shape(servers)[0]) + ' ' + str(avgSatiUsers(users,servers,'matching')) + str(avgSatiUsers(users,servers,'random')) + '' + str(seitaBool)
    print(stringA)
